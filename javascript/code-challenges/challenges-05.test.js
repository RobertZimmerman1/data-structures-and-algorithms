...
const addValues = (arr) => {
  let newArr = arr.reduce(function (accumulator, n) {
...
const addPurchases = (arr) => {
  let pricesArr = arr.map( (value, index) => value.purchasePrice);
  let newArr = pricesArr.reduce( function (accumulator, n) {
    return accumulator + n;
  }, 0);
  return newArr;
};
...
const reversedString = (str) => {
  ...
  let flippedString = splitString.reduce( (reversed, character) => {
